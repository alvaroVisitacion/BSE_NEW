...
@section('contenido') <br>
    ...
    <div class="card_">
        <div class="tittle-cards">
            <h2>
                <font color="black" size="6" style="font-family: Arial">Adquirir: {{ $data->pro_titulo }}
                </font>
            </h2>
        </div>
        <div class="card-body">
               ...
               {{-- <form method="GET" action="{{ route ('servicios.comprar')}}"   enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            background:linear-gradient(30deg, #2D9494, #020226);">
                                    <img style="" src="/img/{{ $data->pro_imagen }}" alt="">
                                 <h5 style="color: #9EF8FE"><span>Descripcion: </span></h5>
                                <p style="color: #ffffff">{{ $data->pro_descripcion }} </p>
                                <h5 style="color: #9EF8FE"><span>Beneficios: </span></h5>
                                <p style="color: #ffffff">{{ $data->pro_beneficio }} </p>
                            </div>
                ...
                <div id="natural_form">
                    ...
                    <form style="background:linear-gradient(50deg, #02204B, #00C1FF); padding: 5px;"
                        ...
                        @endif
                        <input type="hidden" name="codigo" value="{{ $data->pro_codigo }}"> <br>
                        <div class="row ">
                            ...
                            <input class="form-control" type="hidden" value="{{ $data->pro_titulo }}" name="descripcion">
                ...
                <div id="empresa_form" style="background:linear-gradient(50deg,  #00C1FF,#02204B);
                    ...
                    <form method="POST" action="{{ route('ventas.store') }}" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="tipo" value="{{ $data->tipo }}">
                        <input type="hidden" name="codigo" value="{{ $data->pro_codigo }}">
