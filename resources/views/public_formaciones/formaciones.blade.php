                        ...
                        <figure>
                         <img class="card-img-top" src="/img/${arr[vari]["for_imagen"]}" alt="Card image cap"  >
                          ...
                          <div class="card-body des" id="des_${arr[vari][" for_codigo"]}">
                              <h7 class="card-title" style="height:40px">${arr[vari]["for_descripcion"]}</h7>
                              <br> <a href="p_formaciones/${arr[vari]["for_codigo"]}" class="valor">Más información</a>
                          </div>
