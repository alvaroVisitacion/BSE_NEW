    ...
    <div class="container">
        <div class="row justify-content-center pt-5 mt-5 m-1">
            <div class="col-md-6 col-sm-8 col-xl-4 col-lg-5 formulario">
                     ...
                     <div class="card-header" style="color:black; "><span> {{ __('REGISTRAR') }}</span></div>
                    <br><form method="POST" action="{{ route('register') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="email" style="color:black" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail ') }}</label>
