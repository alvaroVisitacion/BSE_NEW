...
<br>  
    <div class="card-header">
         <h1><font color="black" size="6" style="font-family: Times New Roman" >REGISTRO DE SOCIOS</font></h1>  
    </div>
    <div class="card-body">
    <div class="container">
            ...
            @csrf
                ...
                <div class="col-md-12">
                    <div class="row justify-content-center" id="titulo">
                        ...
                        <input type="text" name="soc_titulo" id="soc_titulo" class="form-control col-md-7" placeholder="titulo">
                    </div>
                </div>  
                ...
                <div class="col-md-12">
                    <div class="row justify-content-center" id="titulo">
                        <label for="">DESCRIPCION</label> 
                         <textarea id="soc_descripcion" name="soc_descripcion" rows="3" class=" form-control col-md-7" placeholder="descripcion"></textarea>
                    </div>
                </div>   
                <br><br>
                 <div class="col-md-12">
                    <div class="row justify-content-center" id="titulo">
                        <label for="">Estado</label> 
                         <label class="switch">
                                <input id="soc_estado" name="soc_estado"  class="mi_checkbox  col-md-7" type="checkbox" data-onstyle="success" 
                ...
                <br>
                    <div class="row justify-content-center">
                        ...
                        <input id="soc_imagen" name="soc_imagen"type="file" class=" form-control col-md-7" >
                        </label>
