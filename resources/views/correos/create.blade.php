        ...
        <div class="card2-body">
            ...
            <div class="row">
                        <div class="col-md-12 col-lg-6" style="">
                            ...
                            <div class="col-12" style="color:white;"><span>ENVÍENOS UN MENSAJE <br>Si desea mas información, con gusto le haremos una cotización personalizada, déjenos sus datos seleccionando si es:
                                </span> <br>
                            </div>
                            ...
                            <div id="natural_form">
                                <form style="background:linear-gradient(50deg, #02204B, #00C1FF); padding: 5px;" method="POST" action="{{ route('ventas.store') }}" enctype="multipart/form-data">
