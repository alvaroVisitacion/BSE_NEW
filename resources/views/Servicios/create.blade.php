...
<br>  
    <div class="card-header">
         <h1><font color="black" size="6" style="font-family: Times New Roman" >REGISTRO DE SERVICIOS</font></h1>  
    </div>
    <div class="card-body">
    <div class="container">
            ...
            @csrf
                ...
                <div class="col-md-12">
                    <div class="row justify-content-center" id="titulo">
                        ...
                        <input type="text" name="ser_titulo" id="ser_titulo" class="form-control col-md-7" placeholder="titulo">
                    </div>
                </div>  
                 ...
                 <div class="col-md-12">
                    <div class="row justify-content-center" id="titulo">
                        <label for="">Estado</label> 
                         <label class="switch">
                                <input id="ser_estado" name="ser_estado"  class="mi_checkbox  col-md-7" type="checkbox" data-onstyle="success" 
                ...
                <br>
                    <div class="row justify-content-center">
                        ...
                        <input id="ser_imagen" name="ser_imagen"type="file" class=" form-control col-md-7" >
                        </label>
