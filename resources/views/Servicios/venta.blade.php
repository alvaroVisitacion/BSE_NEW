...
@section('contenido') <br>
    ...
    <div class="card_">
        <div class="tittle-cards">
            <h2>
                <font color="black" size="6" style="font-family: Times New Roman">Adquirir: {{ $data->ser_titulo }}
                </font>
            </h2>
        </div>
        <div class="card-body">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <div class="row justify-content-center">
                                                    <label for=""><span> Agregar imágen del comprobante de
                                                            pago,puede ser captura de pantalla</span></label>
                                                    <input id="imagen" name="imagen"type="file"
                                                        class=" form-control col-md-7">
                                                    </label>
                                                    <span class="pl-1">soporta : PNG, JPG, GIF hasta 10MB</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
