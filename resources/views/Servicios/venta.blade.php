...
<div class="card_">
    <div class="tittle-cards">
        <h2>
            <font color="black" size="6" style="font-family: Arial">Adquirir: {{ $data->ser_titulo }}
            </font>
        </h2>
    </div>
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card" style="margin: 10px;
                    ...
                    <img style="" src="/img/{{ $data->ser_imagen }}" alt="">
                    ...
                    <p style="color: #ffffff">{{ $data->ser_beneficio }} </p>
                </div>
            ...
            <div class="col-md-6" style="">
                    ...
                    <div class="col-12 des"><span>Si desea mas información, con gusto le haremos una cotización personalizada, déjenos sus datos seleccionando si es:
                        </span> <br>
                        </div>
                ...
                <div id="natural_form">
                    ...
                    <form style="background:linear-gradient(50deg, #02204B, #00C1FF); padding: 5px;"
                        ...
                        @endif
                        <input type="hidden" name="codigo" value="{{ $data->ser_codigo }}"> <br>
                        <div class="row ">
                            ...
                            <input class="form-control" type="hidden" value="{{ $data->ser_titulo }}" name="descripcion">
